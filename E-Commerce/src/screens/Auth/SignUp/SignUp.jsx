...
const SignUp = () => {
  ...
  const [termsAccepted, setTermsAccepted] = useState(false); // This state tracks whether the checkbox is checked
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.checkboxContainer}>
            <CheckBox
              isChecked={termsAccepted} // Use state to manage checkbox status
              onClick={() => setTermsAccepted(!termsAccepted)} // Toggle checkbox on click
            />
